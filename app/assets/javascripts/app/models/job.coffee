class App.Job extends App.Model
  ...
  @configure_attributes = [
    ...
    { name: 'admin_folder_id',      display: __('Folder'),                          tag: 'select',   multiple: false, null: true, relation: 'AdminFolder', display_full_name: true, nulloption: true, filter: App.AdminFolder.filterForTargetModel('Job') },
    ...
    { name: 'perform',              display: __('Execute changes on objects'),      tag: 'object_perform_action', null: true, notification: true, ticket_delete: true, data_privacy_deletion_task: true, ai_agent: true, placeholder_current_user: false },
