...
/** Admin message shown as a warning banner to targeted users */
...
/** Autogenerated return type of AdminMessageUpdates. */
export type AdminMessageUpdatesPayload = {
  __typename?: 'AdminMessageUpdatesPayload';
  /** Time of the change */
...
export type DataUnion = OnlineNotificationStandaloneAdminMessageData | OnlineNotificationStandaloneBulkJobData | OnlineNotificationStandaloneKbAnswerGenerationFailedData;
...
/** Meta information for an online notification */
export type OnlineNotificationMeta = {
  __typename?: 'OnlineNotificationMeta';
  createdByAi: Scalars['Boolean']['output'];
};
...
/** Data payload for admin message standalone notifications */
export type OnlineNotificationStandaloneAdminMessageData = {
  __typename?: 'OnlineNotificationStandaloneAdminMessageData';
  adminMessageId: Scalars['Int']['output'];
  message: Scalars['String']['output'];
};
...
export type Overview = {
  ...
  /** User that created this record */
  createdBy?: Maybe<User>;
  /** Internal ID of the folder this overview belongs to, if any */
...
/** Folders grouping ticket overviews */
export type OverviewFolder = {
  __typename?: 'OverviewFolder';
  active: Scalars['Boolean']['output'];
  /** Create date/time of the record */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** User that created this record */
  ...
  internalId: Scalars['Int']['output'];
  name: Scalars['String']['output'];
  /** Internal ID of the parent folder, if any */
...
export type Queries = {
  ...
  /** Admin messages currently shown to the requesting user */
  currentAdminMessages: Array<AdminMessage>;
  ...
  /** Folders grouping the ticket overviews visible to the current user */
  userCurrentTicketOverviewFolders: Array<OverviewFolder>;
...
/** All available queries */
export type QueriesUserCurrentTicketOverviewFoldersArgs = {
  ignoreUserConditions: Scalars['Boolean']['input'];
};
...
export type Subscriptions = {
  ...
  /** Notifies clients that admin messages changed, so they can refetch the current ones */
  adminMessageUpdates: AdminMessageUpdatesPayload;
...
export type CurrentAdminMessagesQueryVariables = Exact<{ [key: string]: never; }>;


export type CurrentAdminMessagesQuery = { __typename?: 'Queries', currentAdminMessages: Array<{ __typename?: 'AdminMessage', id: string, message: string, endAt: string }> };

export type AdminMessageUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type AdminMessageUpdatesSubscription = { __typename?: 'Subscriptions', adminMessageUpdates: { __typename?: 'AdminMessageUpdatesPayload', updatedAt?: string | null } };
...
export type TicketOverviewOrderQuery = { __typename?: 'Queries', ticketOverviews: Array<{ __typename?: 'Overview', id: string, internalId: number, name: string, link: string, prio: number, groupBy?: string | null, orderBy: string, orderDirection: EnumOrderDirection, organizationShared?: boolean | null, outOfOffice?: boolean | null, active: boolean, folderId?: number | null, ticketCount?: number, viewColumns: Array<{ __typename?: 'KeyValue', key: string, value?: string | null }>, orderColumns: Array<{ __typename?: 'KeyValue', key: string, value?: string | null }> }> };
...
export type TicketOverviewUpdatesSubscription = { __typename?: 'Subscriptions', ticketOverviewUpdates: { __typename?: 'TicketOverviewUpdatesPayload', ticketOverviews?: Array<{ __typename?: 'Overview', id: string, internalId: number, name: string, link: string, prio: number, groupBy?: string | null, orderBy: string, orderDirection: EnumOrderDirection, organizationShared?: boolean | null, outOfOffice?: boolean | null, active: boolean, folderId?: number | null, ticketCount?: number, viewColumns: Array<{ __typename?: 'KeyValue', key: string, value?: string | null }>, orderColumns: Array<{ __typename?: 'KeyValue', key: string, value?: string | null }> }> | null } };
...
export type OnlineNotificationsQuery = { __typename?: 'Queries', onlineNotifications: { __typename?: 'OnlineNotificationConnection', edges: Array<{ __typename?: 'OnlineNotificationEdge', cursor: string, node: { __typename?: 'OnlineNotification', id: string, seen: boolean, createdAt: string, typeName: string, objectName: string, createdBy?: { __typename?: 'User', id: string, fullname?: string | null, lastname?: string | null, firstname?: string | null, email?: string | null, vip?: boolean | null, outOfOffice?: boolean | null, outOfOfficeStartAt?: string | null, outOfOfficeEndAt?: string | null, active?: boolean | null, image?: string | null } | null, meta: { __typename?: 'OnlineNotificationMeta', createdByAi: boolean }, metaObject?:
          ...
          | { __typename?: 'OnlineNotificationStandalone', id: string, internalId: number, data:
              | { __typename?: 'OnlineNotificationStandaloneAdminMessageData', message: string, adminMessageId: number }
...
export type OverviewFoldersQueryVariables = Exact<{
  ignoreUserConditions: Scalars['Boolean']['input'];
}>;


export type OverviewFoldersQuery = { __typename?: 'Queries', userCurrentTicketOverviewFolders: Array<{ __typename?: 'OverviewFolder', id: string, internalId: number, name: string, prio: number, parentId?: number | null, active: boolean }> };
